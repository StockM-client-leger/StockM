...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt_check->rowCount() > 0) {
        ...
        header("Refresh: 0; url=/Clientleger/page/inscription.html"); // Attendre 2 secondes avant la redirection
    } else {
        ...
        try {
            ...
            if ($stmt->execute([$nom, $prenom, $email, $mot_de_passe_hache])) {
                ...
                header("Refresh: 0; url=/Clientleger/page/connexion.html"); // Attendre 2 secondes avant la redirection
                exit();
            } else {
